...
object GeneralPreferences {
  ...
  const val KEEP_SCREEN_ON = "idpref_general_keepScreenOn"
  ...
  var keepScreenOn: Boolean
    get() = prefManager.getBoolean(KEEP_SCREEN_ON, false)
    set(value) {
      prefManager.putBoolean(KEEP_SCREEN_ON, value)
    }
  ...
  var autoOpenProjects: Boolean
    get() = prefManager.getBoolean(OPEN_PROJECTS, false)
    set(value) {
