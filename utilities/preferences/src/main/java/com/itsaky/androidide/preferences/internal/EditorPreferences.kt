...
object EditorPreferences {
  ...
  var completionsMatchLower: Boolean
    get() = prefManager.getBoolean(COMPLETIONS_MATCH_LOWER, true)
    set(value) {
  ...
  var fontSize: Float
    get() = prefManager.getFloat(FONT_SIZE, 12f)
    set(value) {
  ...
  var fontLigatures: Boolean
    get() = prefManager.getBoolean(FONT_LIGATURES, false)
    set(value) {
  ...
  var deleteEmptyLines: Boolean
    get() = prefManager.getBoolean(DELETE_EMPTY_LINES, false)
    set(value) {
