...
open class LinearLayoutAdapter<T : LinearLayout> : ViewGroupAdapter<T>() {
  ...
  override fun createUiWidgets(): List<UiWidget> {
    val klass = LinearLayout::class
    val baseTitle = klass.simpleName ?: klass.java.simpleName

    val horizontal =
      LinearLayoutWidget(
        title = baseTitle + " (H)",
        icon = R.drawable.ic_palette_linear_layout_horizontal, isVertical = false)
    val vertical =
      LinearLayoutWidget(
        title = baseTitle + " (V)",
        icon = R.drawable.ic_palette_linear_layout_vertical, isVertical = true)
  ...
  private class LinearLayoutWidget(title: String,
