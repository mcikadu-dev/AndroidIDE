...
public class AndroidUtils {
  ...
  public static String projectNameToPackageName(String moduleName, String packageName) {
    String newProjectName = trimWhiteSpace(moduleName).toLowerCase(Locale.getDefault());
    return getPackageDomain(packageName) + "." + newProjectName;
  }
