...
enum class Sdk(val codename: String, val version: String, val api: Int) {
  ...
  OreoMR1("Oreo", "8.1", 27),
  Pie("Pie", "9.0", 28),
  QuinceTart("Q", "10.0", 29),
  RedVelvetCake("R", "11.0", 30),
  SnowCone("S", "12.0", 31),
  SnowConeV2("Sv2", "12L", 32),
  Tiramisu("Tiramisu", "13.0", 33),
  UpsideDownCake("UpsideDownCake", "14.0", 34),
  ;
   ...
   */
  fun displayName() : String = "API ${api} (\"${codename}\"; Android $version)"
}