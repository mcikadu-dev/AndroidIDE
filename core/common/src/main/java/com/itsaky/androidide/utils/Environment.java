...
import com.itsaky.androidide.utils.ConstantsKt;
...
public final class Environment {
  ...
  public static final int COMPILE_SDK_VERSION = ConstantsKt.getCOMPILE_SDK_VERSION().getApi();;
  ...
  public static File PLATFORMS_DIR;
  ...
  public static void init(Context context) {
    ...
    BUILD_TOOLS_DIR = new File(ANDROID_HOME, "build-tools");
    AAPT2 = new File(BUILD_TOOLS_DIR + "/" + BUILD_TOOLS_VERSION, "aapt2");
    PLATFORMS_DIR = new File(ANDROID_HOME, "platforms");
    ANDROID_JAR = new File(PLATFORMS_DIR + "/android-" + COMPILE_SDK_VERSION, "android.jar");
