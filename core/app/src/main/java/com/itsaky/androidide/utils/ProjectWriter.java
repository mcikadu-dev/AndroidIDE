...
public class ProjectWriter {
  ...
  @NonNull
  public static String createManifestFile() {
    return """
  ...
  @NonNull
  public static String createBuildGradleFile(
    @NonNull String namespace,
    int minSdk,
    Language language,
    boolean useKts
  ) {
    return AndroidModuleTemplateBuilder.buildGradleSrc(
      namespace,
      minSdk,
      language,
      useKts
  ...
  @NonNull
  public static String createProguardRulesFile() {
    return ResourceUtils.readAssets2String(
      "templates/base/module/android/proguard-rules.pro"
    );
  }

  @NonNull
  public static String createGitIgnoreFile() {
    return AndroidModuleTemplateBuilder.gitIgnoreSrc();
  }
  ...
  public static String createClass(String packageName, String className, boolean isKotlin) {
    if (isKotlin) {
  ...
  public static String createInterface(String packageName, String className, boolean isKotlin) {
    if (isKotlin) {
  ...
  public static String createEnum(String packageName, String className, boolean isKotlin) {
    if (isKotlin) {
  ...
  public static String createActivity(String packageName, String className, boolean isKotlin) {
    if (isKotlin) {
