...
private class FontLigatures(
  ...
  override val icon: Int? = drawable.ic_not_equal,
...
private class UseSoftTab(
  ...
  override val icon: Int? = drawable.ic_space_bar,
...
private class TabSize(
  ...
  override val icon: Int? = drawable.ic_keyboard_tab,
...
private class NonPrintablePaintingFlags(
  ...
  override val icon: Int? = drawable.ic_draw,
...
private class CompletionsMatchLower(
  ...
  override val icon: Int? = drawable.ic_match_case,
) : SwitchPreference(
...
private class DeleteEmptyLines(
  ...
  override val icon: Int? = drawable.ic_keyboard_backspace
