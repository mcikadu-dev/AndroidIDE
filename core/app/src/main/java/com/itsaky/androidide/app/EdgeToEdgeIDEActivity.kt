...
abstract class EdgeToEdgeIDEActivity : IDEActivity() {
  ...
  /**
   * Whether the activity applies its background color automatically.
   */
  protected open val applyBackgroundEnabled = true
  ...
  override fun applyActivityBackground() {
    if (!applyBackgroundEnabled) return

    val rootView = findViewById<View>(android.R.id.content)
    rootView.setBackgroundColor(resolveAttr(R.attr.colorSurface))
  }
  ...
  private fun applyKeepScreenOn() {
    if (GeneralPreferences.keepScreenOn) {
