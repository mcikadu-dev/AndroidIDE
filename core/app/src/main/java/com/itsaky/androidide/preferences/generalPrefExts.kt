...
@Parcelize
class CommonConfig(
  override val key: String = "idepref_general_common",
  override val title: Int = string.title_common,
  override val children: List<IPreference> = mutableListOf(),
) : IPreferenceGroup() {
...
@Parcelize
class KeepScreenOn(
  override val key: String = GeneralPreferences.KEEP_SCREEN_ON,
  override val title: Int = R.string.title_keep_screen_on,
  override val summary: Int? = R.string.msg_keep_screen_on,
  override val icon: Int? = R.drawable.ic_mobile
) : SwitchPreference() {

  override fun onCreatePreference(context: Context): Preference {
    val pref = super.onCreatePreference(context) as androidx.preference.SwitchPreference
    pref.isChecked = GeneralPreferences.keepScreenOn
    return pref
  }

  override fun onPreferenceChanged(preference: Preference, newValue: Any?): Boolean {
    GeneralPreferences.keepScreenOn = newValue as Boolean? ?: GeneralPreferences.keepScreenOn
    return true
  }
}
