...
class PermissionsFragment : OnboardingMultiActionFragment(), SlidePolicy {
  ...
  private val runtimePermissionRequestLauncher = registerForActivityResult(
  ...
  companion object {
    ...
    fun getRequiredPermissions(context: Context): List<OnboardingPermissionItem> {
      ...
      permissions.add(OnboardingPermissionItem(Manifest.permission.POST_NOTIFICATIONS,
        R.string.permission_title_notifications, R.string.permission_desc_notifications,
    ...
    fun isNotificationPermissionGranted(context: Context): Boolean {
      return checkSelfPermission(context, Manifest.permission.POST_NOTIFICATIONS)
    }
    ...
    fun isPermissionGranted(context: Context, permission: String): Boolean {
      return when (permission) {
        ...
        Manifest.permission.POST_NOTIFICATIONS -> isNotificationPermissionGranted(context)
  ...
  private fun requestPermission(permission: String) {
    when (permission) {
      ...
      Manifest.permission.POST_NOTIFICATIONS -> requestSettingsTogglePermission(
        Settings.ACTION_APP_NOTIFICATION_SETTINGS, setData = false)
  ...
  private fun requestStoragePermission() {
    ...
    runtimePermissionRequestLauncher.launch(arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE,
      Manifest.permission.WRITE_EXTERNAL_STORAGE))
  }
