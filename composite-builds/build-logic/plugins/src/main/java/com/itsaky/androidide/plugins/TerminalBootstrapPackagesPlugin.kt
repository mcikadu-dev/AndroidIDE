...
class TerminalBootstrapPackagesPlugin : Plugin<Project> {
  ...
  companion object {
    ...
    private val BOOTSTRAP_PACKAGES = mapOf(
      "aarch64" to "6437fc47e51ca7e7b8f7d10755267e0b0798a30dd0fadb5ced31e40fd088d885",
      "arm" to "d83eca61694f38bc38e5441fcc9f713569e799a4f9f4ee879ea8c8e2c76ce08f",
      "x86_64" to "ab3887884cfbcf9687d71f2cd3b693f82d150b75d5217d6232d1691975b191d1"
    )
    ...
    private const val PACKAGES_DOWNLOAD_URL =
      "https://github.com/mcikadu-dev/terminal-packages/releases/download/bootstrap-%1\$s/bootstrap-%2\$s.zip"
  }
